...
\citet{voutilainen2004} states that the around 200 rules are probably enough to resolve 50--75 \% of ambiguities in the corpus used in the development. 
...
grammar's performance, it makes it less readable for human eyes, and
continuing the development is harder. It might make sense to keep two
versions of the grammar: one for maintenance, and other for running,
created automatically from the former.

\input{chapters/cg-expressivity}
