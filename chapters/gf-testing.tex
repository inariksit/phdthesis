...
formalisms such as Tree-Adjoining Grammar
\cite{joshi1975tag}, % Head Grammar \cite{pollard1984phd},
Linear Context-free Rewriting Systems \cite{vijay1987lcfrs}
and Combinatory Categorial Grammar \cite{steedman1988ccg}.
...
from the \t{NP}. We can see clearly which part comes from where:
