...
lot. Table~\ref{results_indiv} shows some expected patterns: Basque
and Estonian have more complex nouns than Dutch, so \t{RelNP} needs
more tests. Likewise, Basque and Dutch have more complex verb phrases
...
clitics in verb phrases. It would be interesting to test two different
implementations of the same language using this method.
...
\todo{Other differences: AdjCN for infl.table behaved more nicely: the
