...
\begin{EmptyItem}
\begin{Highlighting}[]
\DataTypeTok{NP}   \OtherTok{→} \NormalTok{\{ (}\DataTypeTok{PredAdj}\NormalTok{,}\DecValTok{0}\NormalTok{,[s }\DataTypeTok{Nom}\NormalTok{])          }\DataTypeTok{AP}   \OtherTok{→} \NormalTok{\{ (}\DataTypeTok{PredAdj}\NormalTok{,}\DecValTok{1}\NormalTok{,[s }\DataTypeTok{Sg}\NormalTok{])}
       \NormalTok{, (}\DataTypeTok{PredAdv}\NormalTok{,}\DecValTok{0}\NormalTok{,[s }\DataTypeTok{Nom}\NormalTok{])                 , (}\DataTypeTok{PredAdj}\NormalTok{,}\DecValTok{1}\NormalTok{,[s }\DataTypeTok{Pl}\NormalTok{])}
       \NormalTok{, (}\DataTypeTok{UttNP}\NormalTok{,  }\DecValTok{0}\NormalTok{,[s }\DataTypeTok{Nom}\NormalTok{])                 , (}\DataTypeTok{AdjCN}\NormalTok{,  }\DecValTok{0}\NormalTok{,[s }\DataTypeTok{Sg}\NormalTok{]) }
       \NormalTok{, (}\DataTypeTok{PrepNP}\NormalTok{, }\DecValTok{1}\NormalTok{,[s }\DataTypeTok{Acc}\NormalTok{]) \}               , (}\DataTypeTok{AdjCN}\NormalTok{,  }\DecValTok{0}\NormalTok{,[s }\DataTypeTok{Pl}\NormalTok{]) \}}
\DataTypeTok{CN}   \OtherTok{→} \NormalTok{\{ (}\DataTypeTok{DetCN}\NormalTok{,}\DecValTok{1}\NormalTok{,[s }\DataTypeTok{Sg}\NormalTok{])             }\DataTypeTok{Adv}  \OtherTok{→} \NormalTok{\{ (}\DataTypeTok{AdvCN}\NormalTok{,}\DecValTok{0}\NormalTok{,[s]) \}}
       \NormalTok{, (}\DataTypeTok{DetCN}\NormalTok{,}\DecValTok{1}\NormalTok{,[s }\DataTypeTok{Pl}\NormalTok{])             }\DataTypeTok{Prep} \OtherTok{→} \NormalTok{\{ (}\DataTypeTok{PrepNP}\NormalTok{,}\DecValTok{0}\NormalTok{,[s]) \}}
       \NormalTok{, (}\DataTypeTok{AdjCN}\NormalTok{,}\DecValTok{1}\NormalTok{,[s }\DataTypeTok{Sg}\NormalTok{])             }\DataTypeTok{Det}  \OtherTok{→} \NormalTok{\{ (}\DataTypeTok{DetCN}\NormalTok{,}\DecValTok{0}\NormalTok{,[s }\DataTypeTok{Masc}\NormalTok{]) }
       \NormalTok{, (}\DataTypeTok{AdjCN}\NormalTok{,}\DecValTok{1}\NormalTok{,[s }\DataTypeTok{Pl}\NormalTok{]) \}                  , (}\DataTypeTok{DetCN}\NormalTok{,}\DecValTok{0}\NormalTok{,[s }\DataTypeTok{Fem}\NormalTok{]) \}}
\end{Highlighting}
\end{EmptyItem}
