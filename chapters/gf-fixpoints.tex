...
\todo{Write the rest of this section}
...
\todo{The following is what Koen wrote in the paper. Bridge the gap
  between ``fixpoints for dummies'' and ``now that you understand the thing,
