...
\SetWatermarkText{\scshape Draft {\huge \today{}} }
...
% Appendix after chapters 3 and 5
\usepackage{appendix}
\usepackage{chngcntr}
\usepackage{etoolbox}
...
\include{chapters/thesis-intro}
  ...
  %\include{chapters/cg-encoding-and-analysis}
  % attempt at squeezing encoding and analysis into one chapter

\renewcommand{\appendixname}{Appendix: SAT-encoding}

  \include{chapters/cg-sat-encoding}
\begin{subappendices}
...
\renewcommand{\appendixname}{Appendix: General algorithm}
  \include{chapters/gf-testing}
\begin{subappendices}
  \include{chapters/gf-appendix}
\end{subappendices}
